...
class FM_Transmit(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "FM Transmit Recieve", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("FM Transmit Recieve")
        ...
        self._gain_range = qtgui.Range(0, 5, 0.1, 0.1, 200)
        self._gain_win = qtgui.RangeWidget(self._gain_range, self.set_gain, "'gain'", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._gain_win)
        self._freq_range = qtgui.Range(0, 100000, 1000, 440, 200)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, (self.samp_rate*12), 5000, 2000, window.WIN_HAMMING, 6.76))
