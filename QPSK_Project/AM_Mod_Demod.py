...
class AM_Mod_Demod(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "AM MOD DEMOD", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AM MOD DEMOD")
        ...
        self.settings = Qt.QSettings("GNU Radio", "AM_Mod_Demod")
        ...
        self.const1 = const1 = 500

        ##################################################
        # Blocks
        ##################################################

        self._const3_range = qtgui.Range(0, 20, 0.1, 1, 200)
        self._const3_win = qtgui.RangeWidget(self._const3_range, self.set_const3, "Gain", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._const3_win)
        self._const2_range = qtgui.Range(0, 1000, 1, 500, 200)
        self._const2_win = qtgui.RangeWidget(self._const2_range, self.set_const2, "Signal Shift", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._const2_win)
        self._const1_range = qtgui.Range(0, 1000, 1, 500, 200)
        self._const1_win = qtgui.RangeWidget(self._const1_range, self.set_const1, "Signal Amplitude", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._const1_win)
        ...
        self.connect((self.analog_sig_source_x_0_0, 0), (self.blocks_throttle2_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.analog_am_demod_cf_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.analog_sig_source_x_0.set_sampling_freq(int(self.samp_rate))
        self.analog_sig_source_x_0_0.set_sampling_freq(int(self.samp_rate))
    ...
    def set_const3(self, const3):
        self.const3 = const3
        self.blocks_multiply_const_vxx_0.set_k(self.const3)
    ...
    def set_const2(self, const2):
        self.const2 = const2
        self.analog_const_source_x_0_0.set_offset(self.const2*10**-3)
    ...
    def set_const1(self, const1):
        self.const1 = const1
        self.analog_const_source_x_0.set_offset(self.const1*10**-3)




def main(top_block_cls=AM_Mod_Demod, options=None):
